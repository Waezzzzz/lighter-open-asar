...
Built using [OpenAsar](https://github.com/GooseMod/OpenAsar) as a base, but modified to be more practical for everyday use, especially for voice chat and loudmicing.
...
Follow the official OpenAsar installation guide:
...
Original OpenAsar repository:

- [OpenAsar Repository](https://github.com/GooseMod/OpenAsar)
